...
class FrontendTests(unittest.TestCase):
    ...
    def test_interface_assets_are_present_and_connected(self):
        ...
        self.assertIn('data-capabilities-version="2026-09-11"', html)
        self.assertIn('Brave Search 检索中外公开网页', html)
        self.assertIn('DeepSeek 负责整理与问询', html)
        self.assertIn('OpenAlex 与 Crossref 补充作者和论文索引', html)
        self.assertIn('论文资料', html)
        ...
        self.assertIn('id="identity-reject"', html)
        self.assertIn('不是此人', html)
        ...
        self.assertIn('id="biography-section"', html)
        self.assertIn('id="result-biography"', html)
        self.assertIn('href="#biography-section"', html)
        self.assertIn('成长生平', html)
        ...
        self.assertIn('person-remove', javascript)
        self.assertIn('/api/persons/${person.id}', javascript)
        self.assertIn('及其人物资料已删除', javascript)
        ...
        self.assertIn('设为主要来源', javascript)
        self.assertIn('恢复候选', javascript)
        self.assertIn('removed_item_count', javascript)
        self.assertIn('renderReport(payload.report, null, state.activePersonId, false)', javascript)
